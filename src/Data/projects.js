...
export const projects = [
  ...
  // =========================================================================
  {
    ...
    description: "EduSphere is a full-stack Learning Management System built for students, teachers, and administrators using Next.js, React, TypeScript, Node.js, and MongoDB.",
    descriptionAr: "منصة تعليمية ذكية متكاملة (Full Stack LMS) لإدارة العملية التعليمية والربط بين الطلاب والمعلمين والإدارة باستخدام Next.js و React و TypeScript و Node.js و MongoDB.",
    ...
    alt: "EduSphere Learning Management System dashboard",
    features: [
  ...
  },
  {
    ...
    description: "Pharmacy POS is a multi-tenant pharmacy management and point-of-sale system built with React, TypeScript, Node.js, and modern backend architecture.",
    descriptionAr: "نظام متكامل لإدارة الصيدليات ونقاط البيع (POS) مصمم لإدارة العمليات اليومية من مخزون الأدوية، والفروع، والمبيعات، وصلاحيات الموظفين، والنسخ الاحتياطي.",
    ...
    alt: "Pharmacy POS management system dashboard",
    features: [
  ...
  },
  {
    ...
    description: "Zein Hub is a full-stack media and educational platform uniting training programs, lessons, instructor profiles, live sessions, assignments, attendance tracking, and certificates.",
    descriptionAr: "منصة وسائط وتعليم متكاملة تجمع بين البرامج التدريبية والدروس وملفات المدربين والجلسات المباشرة والواجبات والحضور والشهادات مع واجهة برمجية REST API آمنة.",
    ...
    alt: "Zein Hub media and educational platform interface",
    features: [
  ...
  },
  {
    ...
    description: "Sy2antek is a full-stack automotive service and maintenance platform connecting vehicle owners with professional mechanics and automotive services.",
    descriptionAr: "منصة رقمية متكاملة لخدمات صيانة السيارات، تربط أصحاب السيارات بالفنيين المعتمدين ومراكز الصيانة مع إدارة شاملة للطلبات وتعيين الفنيين ولوحة تحكم تفاعلية.",
    ...
    alt: "Sy2antek automotive service and maintenance platform",
    features: [
